...
urlpatterns = [
    ...
    path("assembly/run/", views.sequencing_task, name="assembly_run"),
    ...
    path("annotation/from-job/<str:job_id>/", views.annotation_from_sequencing_task, name="annotation_from_job"),
