...
urlpatterns = [
    ...
    path("annotation/from-fasta/", pipeline.annotation_task, name="annotation_from_fasta"),
    path("annotation/from-json/", pipeline.parse_feature_file, name="annotation_from_json"),
    path("annotation/from-job/<str:job_id>/", pipeline.annotation_from_assembly_task, name="annotation_from_job"),
